    ...
    const locations = () =>
      [
        ...
        },
        {
          ...
          title: 'Your plugins',
          description:
            'Editable plugin folders: source, styles, assets, and native adapters. Edit them here or in Plugin studio.',
          path: path.join(userData, 'plugins'),
          directory: true,
        },
        {
          id: 'chat',
          title: 'Chat history',
          description:
            'One file per conversation: messages, branches, and tool activity. Stored on this device.',
          path: path.join(userData, 'storage', 'chat.threads'),
          directory: true,
        },
        {
          id: 'provider',
        ...
        },
        {
          id: 'contexts',
          title: 'App launchers',
          description: 'Saved VS Code workspaces and browser tab recipes.',
          path: path.join(userData, 'storage', 'app.contexts.json'),
        },
        {
          id: 'secrets',
