...
// (userData/extensions/runtime-sample@1.0.0/) over the sisyphus-ext://
  ...
  const SamplePage = () => {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        `runtime-sample@1.0.0 · visits: ${visits ?? '…'} · store: userData/extensions`,
      ),
    )
  }

  registerPages([
    { id: 'runtime-sample', title: 'Runtime Sample', icon: 'icon-plug', keepAlive: false, component: SamplePage },
  ])
}
